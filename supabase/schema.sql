...
create table if not exists cohorts(
  ...
  -- صف دقيق اختياري (nullable) — grade_band وحده لا يكفي لتمييز مجموعات بنفس النطاق لكن
  -- بصفوف مختلفة فعليًا. راجع migrations/20260918_grade_exact_and_action_reason.sql.
