        ...
        <section className="hero-editorial-v28" style={{ minHeight: "68vh" }}>
          ...
          <div className="container hero-editorial-v28-content">
            <Reveal>
              ...
              <p className="lead">دور المعلم في خُطى هو توجيه الطالب إلى ترتيب أولوياته، الاستمرار في العمل، ومراجعة ما أنجزه.</p>
            </Reveal>
          </div>
        </section>
          ...
          <div className="container">
            <div className="progression">
              {[
                ...
                ["التدخل عند الحاجة", "يتدخل عندما يحتاج الطالب توجيهًا حقيقيًا، ويترك له مساحة للمحاولة."],
